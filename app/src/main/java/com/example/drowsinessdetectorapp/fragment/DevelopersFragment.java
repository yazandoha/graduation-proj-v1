    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.ayanGithubButton:
                url = "https://github.com/drag0o0n";
                break;
            case R.id.souvikGithubButton:
                url = "https://github.com/yazandoha";
                break;
            case R.id.sawonGithubButton:
                url = "https://github.com/obadahattabx";
                break;

            case R.id.ayanLinkedinButton:
                url = "https://www.linkedin.com/in/ahmad-barhoum";
                break;
            case R.id.souvikLinkedinButton:
                url = "https://www.linkedin.com/in/yazan-doha-808437212/";
                break;
            ...
            case R.id.ayanGmailButton:
                url = "abarhoum2@gmail.com";
                break;
            case R.id.souvikGmailButton:
                url = "yazan.doha1999@gmail.com";
                break;
